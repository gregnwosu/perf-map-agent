...
public class AttachOnce {
    public static void main(String[] args) throws Exception {
        ...
        loadAgent(pid, options, path);
    }

    static void loadAgent(String pid, String options,String path) throws Exception {
        VirtualMachine vm = VirtualMachine.attach(pid);
        try {
            vm.loadAgentPath(new File(path).getAbsolutePath(), options);
